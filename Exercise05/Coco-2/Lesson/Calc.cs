// ATTENTION: Replace all occurences of "Calc" by the compiler name! 

// Calc.cs                                                        HDO, 2006-08-28
// -----
// Main program for compiler generated from Calc.atg with Coco-2.
//=====================================|========================================
...
public class Calc {
  ...
  private static void CalcMethod(Utils.ModuleAction action, out String moduleName) {
    moduleName = NAME;
    switch (action) {
  ...
  //-----------------------------------|----------------------------------------
    ...
    Utils.InstallModule("Calc", CalcMethod);

...
public class CalcSyn {

  public static String MODULENAME = "CalcSyn";
  ...
  private const int ROOTPC     =   76;
  private const int LASTTERM   =    7;
  private const int LASTPRAGMA =    7;
  ...
  private class GrammarTable {
    ...
    public byte[] code = {
         4,   1,   1,  14,  11,   4,   2,   1,   1,   1,  20,   0,   4,   2,
         2,  15,  10,   9,   0,   1,   2,  31,   0,   4,   2,   4,  17,  10,
         9,   0,   8,   1,  11,   4,   3,   1,   1,   3,  48,   0,   4,   3,
         2,  15,  10,  37,   0,   1,   4,  59,   0,   4,   3,   4,  17,  10,
        37,   0,   8,   2,  11,   3,   7,  68,   0,   1,  11,   0,   5,   4,
         1,   2,   0,   6,  11,   4,   0,   1,   0,   0,  11
    }; // code
    public NTData[] nts = {
      new NTData(   1, false, new Sets.Set256(0x00a0)),
      new NTData(   6, false, new Sets.Set256(0x00a0)),
      new NTData(  34, false, new Sets.Set256(0x00a0)),
      new NTData(  62, false, new Sets.Set256(0x00a0))
    }; // nts
    public Sets.Set256[] epsSets = {
      new Sets.Set256(0x0041),
      new Sets.Set256(0x0047)
    }; // epsSets
    public Sets.Set256[] anySets = {
      new Sets.Set256(0x0000)
    }; // anySets
    public String[] names = {
      "end of file", "+", "-", "*", "/", "(", ")", "number", "Calc",
      "Expr", "Term", "Fact"
    }; // names
  } // GrammarTable;
  ...
  public static void CalcSynMethod(Utils.ModuleAction action, out String moduleName) {
  //-----------------------------------|----------------------------------------
